  ...
  return (
    <Panel>
      <div className={styles.textContainer}>
        ...
        <h2>Create your own story movie in 3 steps.</h2>
        <ol>
          <li>
        ...
        <hr></hr>
          <p className={styles.p}>Stary AI is powered by ChatGTP, DALL.E and FakeYou.</p>
      </div>
      <div className={styles.imageContainer}>
        <img src={logo} alt="chatGTP Logo" width="70%"></img>
      </div>
    </Panel>
  );
}
